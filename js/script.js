...
function onP1() {
    ...
    pic1.innerHTML = `<img src="img/p1.jpg" alt="imagem do projeto"><h3 class="projectInfo">Museu de arte moderna</h3>`
}
function onP2() {
    const pic2 = document.getElementById('p2');

    pic2.innerHTML = `<img src="img/p2.jpg" alt="imagem do projeto"><h3 class="projectInfo">Residencial AlphaVille</h3>`
}
function onP3() {
    const pic3 = document.getElementById('p3');

    pic3.innerHTML = `<img src="img/p3.jpg" alt="imagem do projeto"><h3 class="projectInfo">Montserrat studio</h3>`
}
function onP4() {
    const pic4 = document.getElementById('p4');

    pic4.innerHTML = `<img src="img/p4.jpg" alt="imagem do projeto"><h3 class="projectInfo">Clinica Grazza</h3>`
}
function onP5() {
    const pic5 = document.getElementById('p5');

    pic5.innerHTML = `<img src="img/p5.jpg" alt="imagem do projeto"><h3 class="projectInfo">Residencial Velaskez</h3>`
}
function onP6() {
    const pic6 = document.getElementById('p6');

    pic6.innerHTML = `<img src="img/p6.jpg" alt="imagem do projeto"><h3 class="projectInfo">Buzios Grand Hotel</h3>`
}
function onP7() {
    const pic7 = document.getElementById('p7');

    pic7.innerHTML = `<img src="img/p7.jpg" alt="imagem do projeto"><h3 class="projectInfo">Buzios Grand Hotel</h3>`
}
function onP8() {
    const pic8 = document.getElementById('p8');

    pic8.innerHTML = `<img src="img/p8.jpg" alt="imagem do projeto"><h3 class="projectInfo">Buzios Grand Hotel</h3>`
}
function onP9() {
    const pic9 = document.getElementById('p9');

    pic9.innerHTML = `<img src="img/p9.jpg" alt="imagem do projeto"><h3 class="projectInfo">Buzios Grand Hotel</h3>`
}
function onP10() {
    const pic10 = document.getElementById('p10');

    pic10.innerHTML = `<img src="img/p10.jpg" alt="imagem do projeto"><h3 class="projectInfo">Hotel Bavaria 1</h3>`
}
function onP11() {
    const pic11 = document.getElementById('p11');

    pic11.innerHTML = `<img src="img/p11.jpg" alt="imagem do projeto"><h3 class="projectInfo">Gavazza gastrô</h3>`
}
function onP12() {
    const pic12 = document.getElementById('p12');

    pic12.innerHTML = `<img src="img/p12.jpg" alt="imagem do projeto"><h3 class="projectInfo">Residencial Várzea tower</h3>`
}
function onP13() {
    const pic13 = document.getElementById('p13');

    pic13.innerHTML = `<img src="img/p13.jpg" alt="imagem do projeto"><h3 class="projectInfo">Henzo apart-hotel</h3>`
}
function onP14() {
    const pic14 = document.getElementById('p14');

    pic14.innerHTML = `<img src="img/p14.jpg" alt="imagem do projeto"><h3 class="projectInfo">TK Tower</h3>`
}
function onP15() {
    const pic15 = document.getElementById('p15');

    pic15.innerHTML = `<img src="img/p15.jpg" alt="imagem do projeto"><h3 class="projectInfo">Residencial Schmith</h3>`
}
function onP16() {
